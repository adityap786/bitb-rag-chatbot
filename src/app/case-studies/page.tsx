					...
					<div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
						<div className="max-w-2xl space-y-4">
							...
							<p className="text-lg text-white/70">
								See how businesses across India are delivering user ecstasy with
								BitB&apos;s AI copilots.
							</p>
						</div>
						<div className="w-full max-w-xs">
							...
							>
								...
								{industrySolutions.map((solution) => (
									<option
										key={solution.name}
										value={solution.name.toLowerCase()}
					...
					<div className="flex items-center justify-between gap-4">
						<div>
							...
							<p className="mt-3 max-w-2xl text-white/70">
								Modular workflows tuned for your business model. Mix-and-match
								intents, channels, and automation depth
					...
					<div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
						<div>
							...
							<p className="mt-3 text-white/70">
								Deep-dive into the automations, uplift, and conversion deltas that
								BitB copilots deliver within weeks.
							</p>
						</div>
						...
						{caseStudies.map((study) => (
							...
							>
								...
								<div className="flex items-center justify-between border-t border-white/5 px-8 py-6 text-sm text-white/70">
									<Link
										href="/resources"
										className="font-medium text-white transition hover:text-white/50"
									>
										Download study →
									</Link>
									<div className="flex gap-3">
			...
			<section className="py-24">
				<div className="max-w-5xl mx-auto px-6">
					<div className="space-y-8 rounded-3xl border border-white/10 bg-white/5 p-16 text-center shadow-2xl backdrop-blur-xl">
						...
						<p className="text-lg text-white/70">
							Join 500+ businesses delivering user ecstasy with BitB copilots.
						</p>
						...
						<p className="text-xs uppercase tracking-[0.2em] text-white/50">
							Download full case study library from{" "}
							<Link
