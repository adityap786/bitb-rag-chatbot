...
const contactOptions = [
	{
		...
		title: "Sales & Demos",
		description:
			"Interested in ELEVATE, SCALE, or DOMINATE? Let\'s show you what\'s possible.",
		cta: "Schedule Demo",
		href: "/demo-booking",
			...
			<section className="py-24">
				<div className="max-w-6xl mx-auto px-6 space-y-6 text-center">
					...
					<p className="text-lg text-white/70">
						Having questions? Need a demo? Want to join our team? We&apos;re here
						and we respond fast.
					</p>
			...
			<section className="py-24">
				<div className="max-w-4xl mx-auto px-6">
					...
					<p className="mt-3 text-white/70">
						Drop a note and we&apos;ll route it straight to the right team. We
						usually respond in under 3 hours.
					</p>
					<form
					...
					>
						...
						{submitted ? (
							<div className="rounded-2xl border border-green-500/30 bg-green-500/10 p-4 text-center text-sm text-green-200">
								Message received! We just sent a confirmation email—expect a reply
								shortly.
							</div>
						) : null}
					</form>
					...
					<div className="space-y-10 rounded-3xl border border-white/10 bg-white/5 p-10 shadow-2xl backdrop-blur-xl">
						<div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
							<div>
								...
								<p className="mt-3 text-white/70">
									Pick a slot that works for you. A product specialist will
									customise the walkthrough for your industry.
								</p>
							</div>
							<Link
					...
					<div className="grid gap-12 lg:grid-cols-2">
						...
						<div className="space-y-6 rounded-3xl border border-white/10 bg-white/5 p-8 shadow-2xl backdrop-blur-xl">
							...
							<p className="text-sm text-white/70">
								Our team collaborates across Bengaluru, Delhi NCR, Mumbai, and Pune
								with async rituals and quarterly offsites. We support flexible
								schedules and remote-friendly onboarding.
							</p>
							<Link
								href="/company/about#careers"
								className="inline-flex items-center gap-2 text-sm text-white/80 hover:translate-x-1"
							>
			...
			<section className="py-24">
				<div className="max-w-4xl mx-auto px-6 text-center">
					...
					<div className="mt-8 flex flex-wrap items-center justify-center gap-6 text-sm text-white/70">
						<Link
							href="https://linkedin.com/company/bitsandbytes"
							target="_blank"
						...
						<Link
							href="https://twitter.com/bitsandbytes"
							target="_blank"
							className="hover:text-white"
						>
							Twitter →
						...
						<Link
							href="https://instagram.com/bitsandbytes"
							target="_blank"
							className="hover:text-white"
						>
							Instagram →
						...
						<Link
							href="https://github.com/bitsandbytes"
							target="_blank"
							className="hover:text-white"
						>
							GitHub →
