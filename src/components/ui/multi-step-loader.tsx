...
export const MultiStepLoader = ({
  ...
  // Use external value if provided, otherwise auto-increment
  const displayValue = externalValue !== undefined ? externalValue : currentState;

  useEffect(() => {
    // Only auto-increment if no external value is provided
